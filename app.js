...
app.use(function(req,res,next){
    ...
    res.locals.filterUserHTML =function(content){
        return sanitizeHTML(markdown(content),{allowedTags:['p','br','ul','ol','li','strong','bold','em','i','h1','h2','h3','h4','h5','h6'],allowedAttributes:{}})
    }

    //make user available errors and success of flash 
